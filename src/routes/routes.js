...
const AppointmentPage = lazy(() => import('../pages/Doctor/AppointmentPage/AppointmentPage'));
const ChildMeasurDoc = lazy(() => import('../pages/Doctor/ChildMeasurDoc/ChildMeasurDoc'));
const Home_manager = lazy(() => import('../pages/administrative_Manager/Home/Home'));
const MotherChildCard = lazy(()=>import('/home/mamoon/graduation folder/graduation/src/component/MotherChildCard/MotherChildCard.jsx'))
const BookAppointment = lazy(()=>import('../component/BookAppointment/BookAppointment'))
const ViewAppointments = lazy(()=>import('../component/ViewAppointments/ViewAppointments'))
const routes =[
  { path: '/', element: <Login /> },
  ...
  { path: '/administrative/manager/home', element: <Home_manager /> },
