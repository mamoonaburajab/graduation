...
function CardChildDoc({ first_name, last_name, BOD, ID }) {
    ...
    return (
        <div className="CardChildDoc" onClick={handleClick}>
            <Card style={{ width: "18rem", height: "30rem", margin: "80px 25px 0px 0px" }} className="card-child">
                <Card.Img variant="top" className="card-img" src="https://img.freepik.com/vetores-premium/desenho-de-rosto-de-menino-bonito_18591-41511.jpg?w=740" />
                <Card.Body>
                ...
                <Card.Body className="card-buttons buttons-card">
                    <Button variant="success" className="btn-child-doc">
                        <Link to="//doctor/vac" className="link-style">التطعيمات</Link>
                    </Button>
                    <Button variant="success" className="btn-child-doc">
